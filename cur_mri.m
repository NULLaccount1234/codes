...
addpath(genpath('../'));
addpath(genpath('./'));
M = niftiread('./data/heart.nii');
parameters(1).osr = 0.10;
parameters(1).iter = 10;
parameters(1).deltas = [0.23, 0.25, 0.27];
parameters(1).r = 15;
parameters(2).osr = 0.15;
parameters(2).iter = 15;
parameters(2).deltas = [0.23, 0.25, 0.27];
parameters(2).r = 15;
parameters(3).osr = 0.20;
parameters(3).iter = 10;
parameters(3).deltas = [0.23, 0.25, 0.27];
parameters(3).r = 5;
parameters(4).osr = 0.25;
parameters(4).iter = 10;
parameters(4).deltas = [0.23, 0.25, 0.27];
parameters(4).r =10;
parameters(5).osr = 0.30;
parameters(5).iter = 10;
parameters(5).deltas = [0.23, 0.25, 0.27];
parameters(5).r = 35;
...
disp(results_table)
filename =  sprintf('/mnt/research/huanglx_group/cur_mri_%d.mat', k);
